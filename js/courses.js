            ...
            for(let i=0; i<data.length; i++){
                ...
                <div class="card border-0">
                    ...
                    <p class="card-text"><p>${data[i]['Orari']}</p>
                        <a href="https://www.pattinaggioconselve.it/page.html#contacts" id="getmap"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
